...
class RESTABOOK_Engine {
    ...
    public function admin_page() {
        require RESTABOOK_PLUGIN_PATH . 'settings.php';
    }
    ...
    public function load_script_css() {
        if ($this->_check_load_script_css()) {
            ...
            wp_enqueue_script('restabookorderjs', RESTABOOK_URL . '/assets/restabookorder.js', array('jquery'), RESTABOOK_VERSION, true);

            wp_enqueue_style('restabookorder', RESTABOOK_URL . '/assets/restabookorder.css', array(), RESTABOOK_VERSION );
        }
    }
